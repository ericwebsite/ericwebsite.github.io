...
"resource": {
  ...
  "rules":[
    [["if",0],["add",0,31,20,21,22,23,24,25]],
    [["if",1,2,3],["add",1,5,6,18,26,28,34,39]],
    [["if",0,4],["add",2,13,17,19,29,30]],
    [["if",0,5],["add",2,13,17,19,29,30]],
    [["if",0,6],["add",2,13,17,19,29,30]],
    [["if",7,8],["add",2,13,17,19,29,30]],
    [["if",8,9],["add",2,13,17,19,29,30]],
    [["if",0,10],["add",2,29]],
    [["if",1,3],["add",3,4,27]],
    [["if",1,3,11],["add",7]],
    [["if",0,12],["add",8,9]],
    [["if",13,14],["add",10,11,12,32,33,35]],
    [["if",15],["add",14,36]],
    [["if",16],["add",15,37]],
    [["if",2,17],["add",16,38]]]
},
...
var xc={},yc=null,zc=Math.random();xc.h="GTM-WSX5PBP";xc.wb="7i2";var Ac={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0},Cc="www.googletagmanager.com/gtm.js";var Dc=Cc,Ec=null,Fc=null,Gc=null,Hc="//www.googletagmanager.com/a?id="+xc.h+"&cv=65",Ic={},Jc={},Kc=function(){var a=yc.sequence||0;yc.sequence=a+1;return a};var G=function(a,b,c,d){return(2===Lc()||d||"http:"!=u.location.protocol?a:b)+c},Lc=function(){var a=Na(),b;if(1===a)a:{var c=Dc;c=c.toLowerCase();for(var d="https://"+c,e="http://"+c,g=1,h=A.getElementsByTagName("script"),k=0;k<h.length&&100>k;k++){var l=h[k].src;if(l){l=l.toLowerCase();if(0===l.indexOf(e)){b=3;break a}1===g&&0===l.indexOf(d)&&(g=2)}}b=g}else b=a;return b};var Mc=!1;
